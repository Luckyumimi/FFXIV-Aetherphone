...
- **Social**: a microblog, a photo feed, and private messaging with voice notes and group calls, plus an optional 18+ companion app available on every playable race.
...
- **Make it yours**: any accent color, wallpapers, Lodestone character portraits, custom ringtones, a text-size zoom, a phone you can drag to any size, and a full CJK font build option for Chinese users.
