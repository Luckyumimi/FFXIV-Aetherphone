...
- **实用工具**：市场板追踪、房屋浏览器、场所与活动目录、音乐、天气、钱包、计时器与重置、照片库与相机、快捷指令，还有一座掌上小游戏街机，尽在 30 多款应用之中。
...
Aetherphone 是开源项目，欢迎贡献。请先阅读开发者文档（英文），再阅读贡献指南。

→ [开发者文档](docs/README.md) · [贡献指南](CONTRIBUTING.md)
